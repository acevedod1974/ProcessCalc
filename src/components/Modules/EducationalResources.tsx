...
export function EducationalResources() {
  ...
  const [activeTab, setActiveTab] = useState<
    "tutorials" | "examples" | "references" | "assignments"
  >("tutorials");
  ...
  const tutorials: Tutorial[] = [
    {
      ...
      description:
        "Learn the fundamentals of metal forming processes including rolling, forging, and extrusion.",
      category: "basics",
      type: "video",
      duration: "45 min",
      difficulty: "beginner",
    ...
    },
    {
      ...
      description:
        "Deep dive into machining operations with tool life prediction and optimization techniques.",
      category: "advanced",
      type: "interactive",
      duration: "90 min",
      difficulty: "advanced",
    ...
    },
    {
      ...
      description:
        "Comprehensive guide to metal cutting processes including punching, shearing, and blanking.",
      category: "basics",
      type: "document",
      duration: "60 min",
    ...
    },
    {
      ...
      description:
        "Real-world examples from automotive, aerospace, and medical device manufacturing.",
  ...
  const examples: Example[] = [
    {
      ...
      description:
        "Step-by-step analysis of rolling process for automotive body panels.",
      process: "Rolling",
    ...
    },
    {
      ...
      description:
        "Analysis of high-precision punching operation for electronic components.",
      process: "Punching",
  ...
  const references: Reference[] = [
    {
      ...
      year: 2011,
      description:
        "Comprehensive textbook covering all aspects of metal forming processes.",
      downloadUrl: "#",
    },
    {
      id: "2",
      ...
      year: 2020,
      description:
        "Industry-standard reference for manufacturing processes and technologies.",
      downloadUrl: "#",
    },
    {
      id: "3",
      ...
      year: 2021,
      description:
        "Standard test methods for determining mechanical properties of materials.",
      downloadUrl: "#",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      >
        ...
        {activeTab === "assignments" && (
          <div className="text-center py-12">
            ...
            <p
              className={`${isDark ? "text-slate-400" : "text-gray-600"} mb-4`}
            >
              Interactive assignments and assessments will be available soon to
              test your knowledge.
            </p>
      ...
      <div
        className={`${
          ...
          isDark ? "border-rose-800" : "border-rose-200"
        }`}
      >
        <div className="flex items-start space-x-3">
          <GraduationCap
            className={`${isDark ? "text-rose-300" : "text-rose-700"} mt-1`}
            size={20}
          />
          <div>
            <h4
            ...
            >
              ...
              <p>
                • Comprehensive reference library with downloadable resources
              </p>
